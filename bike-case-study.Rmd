...
- Casual customers use the classic bikes and members tend to use electric bikes.\
...
This analysis will focus on the first question \>How casual riders and annual members use Cyclistic bikes differently
...
-   Along with the data provided several additional fields were calculated and outlined in the data dictionary in the reference section.\
...
-   Category variable for trips less than or equal 45 minutes or trips longer than 45 minutes - casual user bike rides include the first 45 minutes\

For readability output from the R code was turned off. Source codes is available from the git-hub site 'here'
...
rseed = 53679                                      # Seed starting value
...
table(s$member_casual,s$trip_type)
